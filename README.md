...
* [**pravirkr/sigproc2**](https://github.com/pravirkr/sigproc2): Hypermodern SIGPROC
...
* [**meowgorithm/babyenv**](https://github.com/meowgorithm/babyenv): Go environment var parsing, for babies
...
* [**lowdefy/blocks-amcharts**](https://github.com/lowdefy/blocks-amcharts): Lowdefy blocks for AmCharts 4.
...
* [**matteobachetti/timing-lectures**](https://github.com/matteobachetti/timing-lectures): *No description*
...
* [**mef51/subdriftlaw**](https://github.com/mef51/subdriftlaw): Code for "A simple relationship for the spectro-temporal structure of bursts from FRB121102" and "Evidence of a shared spectro-temporal law between sources of repeating fast radio bursts".
...
* [**astrogewgaw/logos**](https://github.com/astrogewgaw/logos): My open-source store for logos 🎨 !
* [**thepetabyteproject/frbsoft**](https://github.com/thepetabyteproject/frbsoft): FRB Software List
* [**invenia/BlueStyle**](https://github.com/invenia/BlueStyle): A Julia style guide that lives in a blue world
* [**Open-Astrophysics-Bookshelf/about**](https://github.com/Open-Astrophysics-Bookshelf/about): The Open Astrophysics Bookshelf organization repo
...
* [**mmalenta/docker_tutorial**](https://github.com/mmalenta/docker_tutorial): Introductory Docker workshop
...
* [**chime-frb-open-data/community**](https://github.com/chime-frb-open-data/community): CHIME/FRB Community
...
* [**robbassett/pyArt**](https://github.com/robbassett/pyArt): object d'art
...
* [**gica3618/pythonradex**](https://github.com/gica3618/pythonradex): python implementation of RADEX
...
* [**GHRSS/ffapipe**](https://github.com/GHRSS/ffapipe): The GHRSS FFA Pipeline
...
* [**lmmentel/bmatrix**](https://github.com/lmmentel/bmatrix): *No description*
* [**bchangala/nitrogen**](https://github.com/bchangala/nitrogen): NITROGEN is a Python package for rovibronic calculations for small molecules.
* [**mfouesneau/asciiplot**](https://github.com/mfouesneau/asciiplot): Package that allows you to plot simple graphs in ASCII, a la matplotlib
* [**smearedink/CHIMEpulsar**](https://github.com/smearedink/CHIMEpulsar): Scripts for looking at pulsars in CHIME data
* [**liamconnor/injectfrb**](https://github.com/liamconnor/injectfrb): Tools for simulating FRBs and injecting them into real data
* [**benvanwerkhoven/kernel_tuner**](https://github.com/benvanwerkhoven/kernel_tuner): Kernel Tuner
...
* [**jinshisai/PTSMODEL**](https://github.com/jinshisai/PTSMODEL): Protostellar system model for astronomical study.
* [**davidgardenier/frbcat**](https://github.com/davidgardenier/frbcat): Query Fast Radio Burst catalogues
* [**thepetabyteproject/your**](https://github.com/thepetabyteproject/your): Your Unified Reader
* [**cclib/cclib**](https://github.com/cclib/cclib): Parsers and algorithms for computational chemistry logfiles
* [**pmocz/astrojobs**](https://github.com/pmocz/astrojobs): Get latest astronomy job and rumor news in your command line
...
* [**felixpatzelt/colorednoise**](https://github.com/felixpatzelt/colorednoise): Python package to generate Gaussian (1/f)**beta noise (e.g. pink noise)
...
* [**Exahilosys/survey**](https://github.com/Exahilosys/survey): A simple library for creating beautiful interactive prompts.
...
* [**v-morello/iqrm**](https://github.com/v-morello/iqrm): A minimal implementation of the IQRM interference flagging algorithm for radio pulsar and transient searches
* [**tqdm/tqdm**](https://github.com/tqdm/tqdm): A Fast, Extensible Progress Bar for Python and CLI
* [**chubin/wttr.in**](https://github.com/chubin/wttr.in): :partly_sunny: The right way to check the weather
* [**josephwkania/pyspid**](https://github.com/josephwkania/pyspid): These are Classes to communicate with a SPID RAS antenna rotator. These control the Big RAS Rotator for WVU radio telescope
...
* [**fury-gl/fury**](https://github.com/fury-gl/fury): FURY - Free Unified Rendering in pYthon.
* [**chime-frb-open-data/chime-frb-open-data**](https://github.com/chime-frb-open-data/chime-frb-open-data): Utilties for CHIME/FRB Open Data Release
* [**jwkvam/celluloid**](https://github.com/jwkvam/celluloid): :movie_camera: Matplotlib animations made easy
* [**JohannesBuchner/poissonregime**](https://github.com/JohannesBuchner/poissonregime): Poisson error bars for low count statistics, detection significances.
...
* [**keatonb/Pyriod**](https://github.com/keatonb/Pyriod): Python implementation of basic period detection and fitting routines for astronomical time series.
* [**keatonb/TESS_PRF**](https://github.com/keatonb/TESS_PRF): Tools to display the TESS pixel response function (PRF) at any location on the detector
* [**girder/girder**](https://github.com/girder/girder): A data management platform for the web, developed by Kitware
* [**sqlalchemy/alembic**](https://github.com/sqlalchemy/alembic): A database migrations tool for SQLAlchemy.
* [**BezuidenhoutMC/Treebeard**](https://github.com/BezuidenhoutMC/Treebeard): *No description*
* [**BezuidenhoutMC/MosaicUtils**](https://github.com/BezuidenhoutMC/MosaicUtils): *No description*
* [**spacetelescope/astronify**](https://github.com/spacetelescope/astronify): Astronomical data sonification.
* [**pydata/xarray**](https://github.com/pydata/xarray): N-D labeled arrays and datasets in Python
* [**guaix-ucm/rgblues**](https://github.com/guaix-ucm/rgblues): Predicts RGB magnitudes from Gaia EDR3 photometric data.
...
* [**althonos/fs.archive**](https://github.com/althonos/fs.archive): Pyfilesystem2 for various archive filesystems
* [**danielemichilli/DM_phase**](https://github.com/danielemichilli/DM_phase): Tool to calculate the best dispersion measure for a burst using phase information.
* [**paramiko/paramiko**](https://github.com/paramiko/paramiko): The leading native Python SSHv2 protocol library.
* [**althonos/property-cached**](https://github.com/althonos/property-cached): A (better) decorator for caching properties in classes (forked from cached-property).
...
* [**idlesign/keybind**](https://github.com/idlesign/keybind): Global key binding made easy
...
* [**GrahamDoskoch/PulsarOfTheDay**](https://github.com/GrahamDoskoch/PulsarOfTheDay): *No description*
...
* [**0xCoto/CygnusRFI**](https://github.com/0xCoto/CygnusRFI): 📡 CygnusRFI: An open-source RFI analysis tool for Ground Stations & Radio Telescopes
* [**0xCoto/PICTOR**](https://github.com/0xCoto/PICTOR): 📡 The official repository for the free-to-use PICTOR Radio Telescope
* [**0xCoto/Virgo**](https://github.com/0xCoto/Virgo): 📡 Virgo: A Versatile Spectrometer for Radio Astronomy
* [**sqlfluff/sqlfluff**](https://github.com/sqlfluff/sqlfluff): A SQL linter and auto-formatter for Humans
* [**liberfa/pyerfa**](https://github.com/liberfa/pyerfa): Python bindings for ERFA routines
...
* [**telegraphic/fits2hdf**](https://github.com/telegraphic/fits2hdf): FITS to HDFITS conversion utility
* [**telegraphic/numbits**](https://github.com/telegraphic/numbits): Pack / unpack 1-bit 2-bit and 4-bit data in/out of 8-bit numpy arrays.
...
* [**rprechelt/anitacosmicrays**](https://github.com/rprechelt/anitacosmicrays): A Python package to access information and waveforms of cosmic-ray-like-events observed by ANITA.
* [**python-in-astronomy/talk_slides**](https://github.com/python-in-astronomy/talk_slides): A place to put slides (or links to slides) from the meeting
* [**petermckeeverPerform/themepy**](https://github.com/petermckeeverPerform/themepy): An open source theme selector for matplotlib
* [**swincas/contributing_to_open_source**](https://github.com/swincas/contributing_to_open_source): A tutorial about pull-requests and code-review - essential for contributing to open-source
...
* [**sherpa/sherpa**](https://github.com/sherpa/sherpa): Fit models to your data in Python with Sherpa.
* [**transientskp/pyse**](https://github.com/transientskp/pyse): Python Source Extractor
...
* [**pscicluna/precision**](https://github.com/pscicluna/precision): A python pipeline to reduce astronomical IR imaging data. Written with SPHERE data in mind, it provides a fast and easy reduction of bright sources suitable for science. While it may not extract the absolute maximum amount of science, the objective is to provide a means to get science-ready data with minimal computing time or human interaction. Development is ongoing.
* [**pscicluna/pybaycor**](https://github.com/pscicluna/pybaycor): A tool for estimating Bayesian correlation coefficients with python
...
* [**MPoL-dev/MPoL**](https://github.com/MPoL-dev/MPoL): A flexible Python platform for Regularized Maximum Likelihood imaging
...
* [**mtazzari/galario**](https://github.com/mtazzari/galario): Gpu Accelerated Library for Analysing Radio Interferometer Observations
* [**smaret/thindisk**](https://github.com/smaret/thindisk): Compute the line emission from a geometrically thin protoplanetary disk
* [**radio-astro-tools/statcont**](https://github.com/radio-astro-tools/statcont): Continuum measurement tools for crowded-line spectra (and cubes)
* [**radio-astro-tools/casa-formats-io**](https://github.com/radio-astro-tools/casa-formats-io): Code to handle I/O from/to data in CASA format
* [**radio-astro-tools/pvextractor**](https://github.com/radio-astro-tools/pvextractor): Position-Velocity diagram extract (but it can slice out other things too)
* [**radio-astro-tools/casa-python**](https://github.com/radio-astro-tools/casa-python): Thin wrapper to be able to easily run the CASA Python executable
* [**radio-astro-tools/spectral-cube**](https://github.com/radio-astro-tools/spectral-cube): Library for reading and analyzing astrophysical spectral data cubes
* [**radio-astro-tools/radio-beam**](https://github.com/radio-astro-tools/radio-beam): A simple toolkit for reading and manipulating beams from astrophysical radio spectral data cubes.
* [**vtaquet/networks**](https://github.com/vtaquet/networks): Checking and comparing chemical networks.
* [**gabefreedman/pta-outliers**](https://github.com/gabefreedman/pta-outliers): Hierarchical likelihoods for single-pulsar outlier analysis.
* [**vtaquet/coldens_map**](https://github.com/vtaquet/coldens_map): Python routine that creates total column density and rotational temperature maps from various moment 0 maps using a standard rotational diagram analysis.
* [**vtaquet/synth_spect**](https://github.com/vtaquet/synth_spect): Python routine that generates a synthetic sub-mm/mm rotational spectrum from selected species using the CDMS/JPL databases and, optionally, compares it with an observed spectrum.
* [**fatiando/pooch**](https://github.com/fatiando/pooch): A friend to fetch your data files
* [**wvanzeist/riroriro**](https://github.com/wvanzeist/riroriro): A code for simulating gravitational waves and evaluating their detectability.
...
* [**devanshkv/fetch**](https://github.com/devanshkv/fetch): A set of deep learning models for FRB/RFI binary classification.
* [**demorest/sdmpy**](https://github.com/demorest/sdmpy): Python classes for reading VLA/ALMA Science Data Model (SDM)
* [**realfastvla/realfast**](https://github.com/realfastvla/realfast): Real-time interferometric data analysis for the VLA
* [**holoviz/holoviews**](https://github.com/holoviz/holoviews): With Holoviews, your data visualizes itself.
* [**caseyjlaw/rtpipe**](https://github.com/caseyjlaw/rtpipe): Pipeline for real-time fast transient detection in radio interferometric data (see also https://github.com/realfastvla/rfpipe)
* [**prompt-toolkit/ptpython**](https://github.com/prompt-toolkit/ptpython): A better Python REPL
* [**realfastvla/rfpipe**](https://github.com/realfastvla/rfpipe): Fast radio interferometric transient search pipeline
* [**holoviz/datashader**](https://github.com/holoviz/datashader): Quickly and accurately render even the largest data.
* [**astrofrog/mpl-scatter-density**](https://github.com/astrofrog/mpl-scatter-density): :zap: Fast scatter density plots for Matplotlib :zap:
* [**gplynch619/quantum**](https://github.com/gplynch619/quantum): This repository holds code for simulating 1D quantum systems
...
* [**joshspeagle/brutus**](https://github.com/joshspeagle/brutus): Modeling stellar photometry with "brute force" methods
* [**joshspeagle/dynesty**](https://github.com/joshspeagle/dynesty): Dynamic Nested Sampling package for computing Bayesian posteriors and evidences
* [**dfm/emcee**](https://github.com/dfm/emcee): The Python ensemble sampling toolkit for affine-invariant MCMC
* [**rhayes777/PyAutoFit**](https://github.com/rhayes777/PyAutoFit): *No description*
* [**simonsobs/hmvec**](https://github.com/simonsobs/hmvec): Vectorized halo model code written entirely in pure Python / numpy
* [**halomod/hmf**](https://github.com/halomod/hmf): Python halo mass function calculator
...
* [**duartegroup/autodE**](https://github.com/duartegroup/autodE): automated reaction profile generation
* [**OpenAstronomy/baldrick**](https://github.com/OpenAstronomy/baldrick): I have a cunning plan!
* [**asciinema/asciinema**](https://github.com/asciinema/asciinema): Terminal session recorder 📹
* [**fermiPy/fermipy**](https://github.com/fermiPy/fermipy): Fermi-LAT Python Analysis Framework
...
* [**KyleM73/n_body_simulator**](https://github.com/KyleM73/n_body_simulator): N-Body Dynamics Simulator
...
* [**twintproject/twint-utils**](https://github.com/twintproject/twint-utils): Collection of scripts for The TWINT project
...
* [**laserkelvin/PySpecTools**](https://github.com/laserkelvin/PySpecTools): Routines for rotational spectroscopy analysis written in Python 3
* [**v-morello/clfd**](https://github.com/v-morello/clfd): Smart RFI removal algorithms to be used on folded pulsar search and timing data
* [**v-morello/riptide**](https://github.com/v-morello/riptide): Pulsar searching with the Fast Folding Algorithm (FFA)
...
* [**raphlinus/pulldown-cmark**](https://github.com/raphlinus/pulldown-cmark): *No description*
* [**StardustDL/Linq-in-Rust**](https://github.com/StardustDL/Linq-in-Rust): Language Integrated Query in Rust.
* [**ludat/hado-rs**](https://github.com/ludat/hado-rs): *No description*
...
* [**ogham/rust-term-grid**](https://github.com/ogham/rust-term-grid): Rust library for putting things in a grid
...
* [**philippkeller/rexpect**](https://github.com/philippkeller/rexpect): Rust port of pexpect
...
* [**LukasKalbertodt/bunt**](https://github.com/LukasKalbertodt/bunt): Simple macros to write colored and formatted text to a terminal. Based on `termcolor`, thus also cross-platform.
...
* [**vitiral/termstyle**](https://github.com/vitiral/termstyle): create and test the style and formatting of text in your terminal applications
...
* [**rust-cli/thunder**](https://github.com/rust-cli/thunder): ⚡ Zero-boilerplate commandline argument parsing in Rust
...
* [**reugn/rspark**](https://github.com/reugn/rspark): ▁▂▆▇▁▄█▁ Sparklines for Rust apps
...
* [**smearedink/phase-connect**](https://github.com/smearedink/phase-connect): A brute-force pulsar phase connection method
* [**pfreire163/Dracula**](https://github.com/pfreire163/Dracula): Determining the RotAtion Count of pULsArs
* [**kdabir/has**](https://github.com/kdabir/has): ✅ checks presence of various command line tools and their versions on the path
* [**astrogewgaw/astrogewgaw**](https://github.com/astrogewgaw/astrogewgaw): My GitHub README and my personal website rolled into one.
* [**ypmen/BasebandX**](https://github.com/ypmen/BasebandX): coherent dedispersion and real-time folding (only folding part is available, coherent dedispersion is still in development and test)
* [**ypmen/PlotX**](https://github.com/ypmen/PlotX): This is a matplotlib-like c++ wrapper for pgplot!
